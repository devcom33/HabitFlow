      ...
      <div className="p-5 space-y-4">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className={`relative flex-shrink-0 w-10 h-10 rounded-lg border-2 flex items-center justify-center transition-all duration-200 transform hover:scale-105 ${
              completion.completed
          ...
          >
            ...
            {!completion.completed && (
              <div className="w-2 h-2 rounded-sm bg-gray-500 group-hover:bg-green-400 transition-colors duration-200" />
            )}
          </button>
        </div>
      </div>
